...
@implementation ApiDefinition__UqudoSDK_UQBuilderControllerDelegate {
}
	...
	-(id) init
	{
		static MonoMethod *managed_method = NULL;
		bool call_super = false;
		id rv = native_to_managed_trampoline_4 (self, _cmd, &managed_method, &call_super, 0x4308);
		if (call_super && rv) {
...
@implementation demo_UqudoBuilderControllerDelegate {
	XamarinObject __monoObjectGCHandle;
}
	-(void) release
	{
	...
	-(id) init
	{
		static MonoMethod *managed_method = NULL;
		bool call_super = false;
		id rv = native_to_managed_trampoline_4 (self, _cmd, &managed_method, &call_super, 0x1500);
		if (call_super && rv) {
			struct objc_super super = {  rv, [NSObject class] };
			rv = ((id (*)(objc_super*, SEL)) objc_msgSendSuper) (&super, @selector (init));
		}
...
@implementation Foundation_NSDispatcher {
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_8 (self, _cmd, &managed_method, 0x3A04);
	}
	-(BOOL) conformsToProtocol: (void *) protocol
	{
		GCHandle exception_gchandle;
	...
	-(id) init
	{
		static MonoMethod *managed_method = NULL;
		bool call_super = false;
		id rv = native_to_managed_trampoline_4 (self, _cmd, &managed_method, &call_super, 0x3904);
		if (call_super && rv) {
			struct objc_super super = {  rv, [NSObject class] };
			rv = ((id (*)(objc_super*, SEL)) objc_msgSendSuper) (&super, @selector (init));
		}
...
@implementation __MonoMac_NSSynchronizationContextDispatcher {
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_8 (self, _cmd, &managed_method, 0x3C04);
	}
@end
...
@implementation Foundation_NSAsyncDispatcher {
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_8 (self, _cmd, &managed_method, 0x3E04);
	}
	...
	-(id) init
	{
		static MonoMethod *managed_method = NULL;
		bool call_super = false;
		id rv = native_to_managed_trampoline_4 (self, _cmd, &managed_method, &call_super, 0x3D04);
		if (call_super && rv) {
...
@implementation __MonoMac_NSAsyncSynchronizationContextDispatcher {
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_8 (self, _cmd, &managed_method, 0x4004);
	}
@end
...
@implementation __NSObject_Disposer {
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_10 (self, _cmd, &managed_method, p0, 0xB704);
	}
	-(BOOL) conformsToProtocol: (void *) protocol
	{
		GCHandle exception_gchandle;
	...
	-(id) init
	{
		static MonoMethod *managed_method = NULL;
		bool call_super = false;
		id rv = native_to_managed_trampoline_4 (self, _cmd, &managed_method, &call_super, 0xB504);
		if (call_super && rv) {
			struct objc_super super = {  rv, [NSObject class] };
			rv = ((id (*)(objc_super*, SEL)) objc_msgSendSuper) (&super, @selector (init));
		}
...
#pragma clang diagnostic ignored "-Wobjc-protocol-property-synthesis"
#pragma clang diagnostic ignored "-Wobjc-property-implementation"
@implementation ApiDefinition__UqudoSDK_UQAccountRecoveryBuilderDelegate {
}
	...
	-(id) init
	{
		static MonoMethod *managed_method = NULL;
		bool call_super = false;
		id rv = native_to_managed_trampoline_4 (self, _cmd, &managed_method, &call_super, 0x2708);
		if (call_super && rv) {
			struct objc_super super = {  rv, [NSObject class] };
			rv = ((id (*)(objc_super*, SEL)) objc_msgSendSuper) (&super, @selector (init));
		}
...
#pragma clang diagnostic ignored "-Wobjc-protocol-property-synthesis"
#pragma clang diagnostic ignored "-Wobjc-property-implementation"
@implementation ApiDefinition__UqudoSDK_UQEnrollmentBuilderDelegate {
}
	...
	-(id) init
	{
		static MonoMethod *managed_method = NULL;
		bool call_super = false;
		id rv = native_to_managed_trampoline_4 (self, _cmd, &managed_method, &call_super, 0xA008);
		if (call_super && rv) {
			struct objc_super super = {  rv, [NSObject class] };
			rv = ((id (*)(objc_super*, SEL)) objc_msgSendSuper) (&super, @selector (init));
		}
...
#pragma clang diagnostic ignored "-Wobjc-protocol-property-synthesis"
#pragma clang diagnostic ignored "-Wobjc-property-implementation"
@implementation ApiDefinition__UqudoSDK_UQFaceSessionBuilderDelegate {
}
	...
	-(id) init
	{
		static MonoMethod *managed_method = NULL;
		bool call_super = false;
		id rv = native_to_managed_trampoline_4 (self, _cmd, &managed_method, &call_super, 0xC908);
		if (call_super && rv) {
			struct objc_super super = {  rv, [NSObject class] };
			rv = ((id (*)(objc_super*, SEL)) objc_msgSendSuper) (&super, @selector (init));
		}
...
#pragma clang diagnostic pop
	...
	static MTClassMap __xamarin_class_map [] = {
		{ NULL, 0x1604 /* #0 'NSObject' => 'Foundation.NSObject, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		...
		{ NULL, 0x400 /* #3 'AppDelegate' => 'demo.AppDelegate, demo' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		{ NULL, 0x3404 /* #4 'UIViewController' => 'UIKit.UIViewController, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x500 /* #5 'ViewController' => 'demo.ViewController, demo' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		{ NULL, 0xA08 /* #6 'ApiDefinition__UqudoSDK_UQBuilderControllerDelegate' => 'UqudoSDK.UQBuilderControllerDelegate, UqudoSDK' */, (MTTypeFlags) (1) /* CustomType */ },
		{ NULL, 0x600 /* #7 'demo_UqudoBuilderControllerDelegate' => 'demo.UqudoBuilderControllerDelegate, demo' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		{ NULL, 0x904 /* #8 'Foundation_NSDispatcher' => 'Foundation.NSDispatcher, Xamarin.iOS' */, (MTTypeFlags) (2) /* UserType */ },
		{ NULL, 0xA04 /* #9 '__MonoMac_NSSynchronizationContextDispatcher' => 'Foundation.NSSynchronizationContextDispatcher, Xamarin.iOS' */, (MTTypeFlags) (2) /* UserType */ },
		{ NULL, 0xB04 /* #10 'Foundation_NSAsyncDispatcher' => 'Foundation.NSAsyncDispatcher, Xamarin.iOS' */, (MTTypeFlags) (2) /* UserType */ },
		{ NULL, 0xC04 /* #11 '__MonoMac_NSAsyncSynchronizationContextDispatcher' => 'Foundation.NSAsyncSynchronizationContextDispatcher, Xamarin.iOS' */, (MTTypeFlags) (2) /* UserType */ },
		{ NULL, 0xD04 /* #12 'NSArray' => 'Foundation.NSArray, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0xE04 /* #13 'NSAutoreleasePool' => 'Foundation.NSAutoreleasePool, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x1104 /* #14 'NSError' => 'Foundation.NSError, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x1504 /* #15 'NSNull' => 'Foundation.NSNull, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x1C04 /* #16 'NSRunLoop' => 'Foundation.NSRunLoop, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x1D04 /* #17 'NSSet' => 'Foundation.NSSet, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x2004 /* #18 'NSString' => 'Foundation.NSString, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x2104 /* #19 'NSUUID' => 'Foundation.NSUuid, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x2704 /* #20 'NSEnumerator' => 'Foundation.NSEnumerator, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x2804 /* #21 'NSException' => 'Foundation.NSException, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x3104 /* #22 'UIApplication' => 'UIKit.UIApplication, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x3304 /* #23 'UIView' => 'UIKit.UIView, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x3504 /* #24 'UIWindow' => 'UIKit.UIWindow, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x3904 /* #25 'UIScene' => 'UIKit.UIScene, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x3A04 /* #26 'UISceneConfiguration' => 'UIKit.UISceneConfiguration, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x3B04 /* #27 'UISceneConnectionOptions' => 'UIKit.UISceneConnectionOptions, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x3E04 /* #28 'UISceneSession' => 'UIKit.UISceneSession, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0xF04 /* #29 'NSDictionary' => 'Foundation.NSDictionary, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x1A04 /* #30 '__NSObject_Disposer' => 'Foundation.NSObject+NSObject_Disposer, Xamarin.iOS' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		{ NULL, 0x308 /* #31 'UQAccountRecoveryBuilder' => 'UqudoSDK.UQAccountRecoveryBuilder, UqudoSDK' */, (MTTypeFlags) (1) /* CustomType */ },
		{ NULL, 0x608 /* #32 'ApiDefinition__UqudoSDK_UQAccountRecoveryBuilderDelegate' => 'UqudoSDK.UQAccountRecoveryBuilderDelegate, UqudoSDK' */, (MTTypeFlags) (1) /* CustomType */ },
		{ NULL, 0x708 /* #33 'UQBuilderController' => 'UqudoSDK.UQBuilderController, UqudoSDK' */, (MTTypeFlags) (1) /* CustomType */ },
		{ NULL, 0xB08 /* #34 'UQDocumentConfig' => 'UqudoSDK.UQDocumentConfig, UqudoSDK' */, (MTTypeFlags) (1) /* CustomType */ },
		{ NULL, 0xC08 /* #35 'UQEnrollmentBuilder' => 'UqudoSDK.UQEnrollmentBuilder, UqudoSDK' */, (MTTypeFlags) (1) /* CustomType */ },
		{ NULL, 0xF08 /* #36 'ApiDefinition__UqudoSDK_UQEnrollmentBuilderDelegate' => 'UqudoSDK.UQEnrollmentBuilderDelegate, UqudoSDK' */, (MTTypeFlags) (1) /* CustomType */ },
		{ NULL, 0x1008 /* #37 'UQFaceSessionBuilder' => 'UqudoSDK.UQFaceSessionBuilder, UqudoSDK' */, (MTTypeFlags) (1) /* CustomType */ },
		{ NULL, 0x1308 /* #38 'ApiDefinition__UqudoSDK_UQFaceSessionBuilderDelegate' => 'UqudoSDK.UQFaceSessionBuilderDelegate, UqudoSDK' */, (MTTypeFlags) (1) /* CustomType */ },
		{ NULL, 0x1408 /* #39 'UQReadingConfig' => 'UqudoSDK.UQReadingConfig, UqudoSDK' */, (MTTypeFlags) (1) /* CustomType */ },
		{ NULL, 0x1508 /* #40 'UQScanConfig' => 'UqudoSDK.UQScanConfig, UqudoSDK' */, (MTTypeFlags) (1) /* CustomType */ },
		{ NULL, 0x1608 /* #41 'UQSessionStatus' => 'UqudoSDK.UQSessionStatus, UqudoSDK' */, (MTTypeFlags) (1) /* CustomType */ },
		{ NULL, 0 },
	};

	static const MTManagedClassMap __xamarin_skipped_map [] = {
		{ 0x1F04, 0x1D04 /* 'Foundation.NSSet`1' => 'Foundation.NSSet' */ },
	};

	static const MTAssembly __xamarin_registration_assemblies [] = {
		{ "demo", "2dfebc3c-4c92-4dac-b449-e7553d3484ce" }, 
		{ "mscorlib", "ae4d2b2e-1a52-451b-bb0f-be726a40b592" }, 
		{ "Xamarin.iOS", "153620f8-57f5-4f9c-9ab1-e7a1e6853772" }, 
		{ "System", "14efc017-c0c2-49f1-ab8d-cce611967aea" }, 
		{ "UqudoSDK", "e086ac6a-cff1-4f57-be30-795e4e05526a" }
	};

	static const MTProtocolWrapperMap __xamarin_protocol_wrapper_map [] = {
		{ 0x408 /* UqudoSDK.IUQAccountRecoveryBuilderDelegate */, 0x508 /* UQAccountRecoveryBuilderDelegateWrapper */ },
		{ 0x808 /* UqudoSDK.IUQBuilderControllerDelegate */, 0x908 /* UQBuilderControllerDelegateWrapper */ },
		{ 0xD08 /* UqudoSDK.IUQEnrollmentBuilderDelegate */, 0xE08 /* UQEnrollmentBuilderDelegateWrapper */ },
		{ 0x1108 /* UqudoSDK.IUQFaceSessionBuilderDelegate */, 0x1208 /* UQFaceSessionBuilderDelegateWrapper */ },
		{ 0x2904 /* Foundation.INSObjectProtocol */, 0x2A04 /* NSObjectProtocolWrapper */ },
		{ 0x3604 /* UIKit.IUIApplicationDelegate */, 0x3704 /* UIApplicationDelegateWrapper */ },
...
void xamarin_create_classes () {
	...
	__xamarin_class_map [6].handle = [ApiDefinition__UqudoSDK_UQBuilderControllerDelegate class];
	__xamarin_class_map [7].handle = [demo_UqudoBuilderControllerDelegate class];
	...
	__xamarin_class_map [17].handle = objc_getClass ("NSSet");
	__xamarin_class_map [18].handle = objc_getClass ("NSString");
	__xamarin_class_map [19].handle = objc_getClass ("NSUUID");
	__xamarin_class_map [20].handle = objc_getClass ("NSEnumerator");
	...
	__xamarin_class_map [31].handle = [UQAccountRecoveryBuilder class];
	__xamarin_class_map [32].handle = [ApiDefinition__UqudoSDK_UQAccountRecoveryBuilderDelegate class];
	__xamarin_class_map [33].handle = [UQBuilderController class];
	__xamarin_class_map [34].handle = [UQDocumentConfig class];
	__xamarin_class_map [35].handle = [UQEnrollmentBuilder class];
	__xamarin_class_map [36].handle = [ApiDefinition__UqudoSDK_UQEnrollmentBuilderDelegate class];
	__xamarin_class_map [37].handle = [UQFaceSessionBuilder class];
	__xamarin_class_map [38].handle = [ApiDefinition__UqudoSDK_UQFaceSessionBuilderDelegate class];
	__xamarin_class_map [39].handle = [UQReadingConfig class];
	__xamarin_class_map [40].handle = [UQScanConfig class];
	__xamarin_class_map [41].handle = [UQSessionStatus class];
