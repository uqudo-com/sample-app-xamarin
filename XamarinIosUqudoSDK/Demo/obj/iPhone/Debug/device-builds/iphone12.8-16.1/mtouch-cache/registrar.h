...
@class UQLookupBuilder;
@protocol UQLookupBuilderDelegate;
@class ApiDefinition__UqudoSDK_UQLookupBuilderDelegate;
...
@protocol UQBuilderControllerDelegate
	...
	@optional -(void) didLookupFlowCompleteWithInfo:(NSString *)p0;
	@optional -(void) didLookupFlowIncompleteWithStatus:(id)p0;
@end
...
@interface demo_UqudoBuilderControllerDelegate : NSObject<UQBuilderControllerDelegate> {
	...
	-(void) didLookupFlowCompleteWithInfo:(NSString *)p0;
	-(void) didLookupFlowIncompleteWithStatus:(id)p0;
	-(BOOL) conformsToProtocol:(void *)p0;
	-(id) init;
@end
...
@interface UQDocumentConfig : NSObject {
	...
	-(BOOL) isEnrollmentSupported;
	-(BOOL) isLookupFacialRecognitionSupported;
	-(BOOL) isLookupSupported;
...
@interface UQLookupBuilder : NSObject {
}
	-(void) enableAuditTrailImageObfuscation:(NSInteger)p0;
	-(void) enableBackgroundCheck:(BOOL)p0 type:(NSInteger)p1;
	-(void) enableBackgroundCheck:(BOOL)p0 type:(NSInteger)p1 monitoring:(BOOL)p2;
	...
	-(void) setAuthorizationToken:(NSString *)p0;
	-(NSInteger) documentType;
	-(void) setDocumentType:(NSInteger)p0;
	-(BOOL) enableFacialRecognition;
	-(void) setEnableFacialRecognition:(BOOL)p0;
	-(BOOL) enrollFace;
	-(void) setEnrollFace:(BOOL)p0;
	-(NSInteger) facialRecognitionMaxAttempts;
	-(void) setFacialRecognitionMaxAttempts:(NSInteger)p0;
	-(NSInteger) facialRecognitionMinimumMatchLevel;
	-(void) setFacialRecognitionMinimumMatchLevel:(NSInteger)p0;
	-(NSString *) nonce;
	-(void) setNonce:(NSString *)p0;
	-(BOOL) returnDataForIncompleteSession;
	-(void) setReturnDataForIncompleteSession:(BOOL)p0;
...
@protocol UQLookupBuilderDelegate
	@required -(void) didLookupFlowCompleteWithInfo:(NSString *)p0;
	@required -(void) didLookupFlowIncompleteWithStatus:(id)p0;
@end

@interface ApiDefinition__UqudoSDK_UQLookupBuilderDelegate : NSObject<UQLookupBuilderDelegate> {
}
	-(id) init;
@end
